    ...
    stages {
        ...
        stage('build & push') {
            steps {
                    ...
                    sh 'docker build -f Dockerfile -t $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:SNAPSHOT-$TAG_NAME .'
...
docker push $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:SNAPSHOT-$TAG_NAME'''
        ...
        stage('push latest') {
            ...
            steps {
                    ...
                    sh 'docker tag $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:SNAPSHOT-$TAG_NAME $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:latest'
...
sed -i\'\' "s#TAG_NAME#$TAG_NAME#" deploy/cicd-demo-dev.yaml
...
//                }
                    ...
                    sh 'docker tag $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:SNAPSHOT-$TAG_NAME $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:$TAG_NAME'
